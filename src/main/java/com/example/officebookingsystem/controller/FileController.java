...
import com.example.officebookingsystem.domain.dto.response.UploadFileResponse;
import com.example.officebookingsystem.service.FileStorageService;
...
public class FileController {
    ...
    public UploadFileResponse uploadFile(@RequestParam("file") MultipartFile file,
            @RequestParam BuildingRequest buildingRequest) {
        System.out.println(buildingRequest.getAddress());
        System.out.println(buildingRequest.getName());
        ...
        return new UploadFileResponse(fileName, fileLoadUri,
